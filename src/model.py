...
class DCGAN:
    ...
    def __init__(self, loss_fn=nn.BCELoss, ngpu=1):
        self.image_size = 64
        self.nc = 1  # Number of channels (3 for RGB)
        ...
        self.device = 'cpu'
        self.gen = Generator(self.nz, self.ngf, self.nc)
        self.gen = self.gen.to(self.device)
        self.disc = Discriminator(self.ngf, self.nc)
...
if __name__ == "__main__":
    gan = DCGAN()
    gan.fit(epochs=300, dataset_path='/Users/Corty/Downloads/signatures')
